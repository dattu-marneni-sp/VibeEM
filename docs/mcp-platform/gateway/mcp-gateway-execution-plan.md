...
**MCP Platform:** [`../README.md`](../README.md) · sub-topic: **MCP Gateway** ([INIT-2704](https://sailpoint.atlassian.net/browse/INIT-2704))
...
For background concepts, see [`mcp-gateway.md`](mcp-gateway.md). Platform context: [`../README.md`](../README.md).
...
**Related documents:** [MCP Platform hub](../README.md) · [`mcp-gateway.md`](mcp-gateway.md) · [`mcp-gateway-mvp-spec.md`](mcp-gateway-mvp-spec.md) · [`mcp-gateway-delivery-kit.md`](mcp-gateway-delivery-kit.md) (week-1, Jira, RACI, risks, cost, [skills ramp](mcp-gateway-delivery-kit.md#9-skills-ramp--learn-from-the-repos-not-from-scratch), [success checklist](mcp-gateway-delivery-kit.md#10-success-checklist--what-done-looks-like)) · [`mcp-gateway-rollout-migration-sync.md`](mcp-gateway-rollout-migration-sync.md) (May 2026 global URL vs AgentCore GW) · [Server registry](../mcp-server-registry.md) · [Observability](../mcp-observability.md) · **PRD 1:** [\[MCP Q1-2 PRD\] Single URL and OAuth Support](https://sailpoint.atlassian.net/wiki/spaces/~7120200fd8a6740fdb4ca9bd0f88f478f134a5/pages/4634738812/MCP+Q1-2+PRD+SailPoint+MCP+Server+Single+URL+and+Oauth+Support) · **PRD 2:** [\[MCP PRD\] Tenant-Agnostic Endpoint & OAuth Integration](https://sailpoint.atlassian.net/wiki/spaces/~7120200fd8a6740fdb4ca9bd0f88f478f134a5/pages/4342448180/MCP+PRD+Tenant-Agnostic+MCP+Server+Endpoint+Oauth+Integration)
...
4. **Do not** ship gateway MVP without a plan to refresh public docs — customers will otherwise see only the old tenant-URL flow ([competitive gap](mcp-gateway.md) vs marketplace listings).
...
| **Docs** | [`mcp-gateway-mvp-spec.md`](mcp-gateway-mvp-spec.md), this execution plan. Platform hub: [`../README.md`](../README.md). |
...
| **Implication for INIT-2704** | INIT-2704 is a **concrete slice** of Phase 1/2 platform thinking (gateway + auth + routing), not the full platform (registry, observability at scale, IIQ routing, tool generation, marketplace). See [`../mcp-server-registry.md`](../mcp-server-registry.md), [`../mcp-observability.md`](../mcp-observability.md). **Do not** expand INIT-2704 scope to “build the entire MCP Platform” while INIT-2410 is below the line. |
...
**Slack signal (May 22–25):** [Jinder Aujla → Ye Zhu](https://sailpoint.slack.com/archives/C09R91SCJ9L/p1779485709467059) — global URL testing close; **future AgentCore GW** will require **registered client migration** when access-request OAuth metadata / auth server changes off sp-token. Captured in [`mcp-gateway-rollout-migration-sync.md`](mcp-gateway-rollout-migration-sync.md) and [DPDE-1767](https://sailpoint.atlassian.net/browse/DPDE-1767).
...
- **B1.** AgentCore Gateway architecture in detail (targets, identity, semantic search, sync model). Lift from [`mcp-gateway.md`](mcp-gateway.md) §"Reference Architecture".
...
- **B4.** Competitive benchmark — Saviynt, Wiz, GitHub MCP, Atlassian Remote MCP, Linear MCP. Lift from PRD 2 §"Competitive Benchmark" and [`mcp-gateway.md`](mcp-gateway.md) §"Examples In The Wild".
...
| MCP Platform hub | [`../README.md`](../README.md) |
| MVP specification | [`mcp-gateway-mvp-spec.md`](mcp-gateway-mvp-spec.md) |
| Rollout & migration sync (May 2026) | [`mcp-gateway-rollout-migration-sync.md`](mcp-gateway-rollout-migration-sync.md) · [Confluence](https://sailpoint.atlassian.net/wiki/spaces/data/pages/5135074261/INIT-2704+MCP+rollout+and+migration+sync+May+2026) |
