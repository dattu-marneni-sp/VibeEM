...
**Related documents:** [MCP Platform hub](../README.md) · [`mcp-gateway.md`](mcp-gateway.md) · [`mcp-gateway-execution-plan.md`](mcp-gateway-execution-plan.md) · [`mcp-gateway-delivery-kit.md`](mcp-gateway-delivery-kit.md) · [`mcp-gateway-rollout-migration-sync.md`](mcp-gateway-rollout-migration-sync.md) (May 2026 rollout / client migration) · [Server registry](../mcp-server-registry.md) · [Observability](../mcp-observability.md) · **PRD 1:** [\[MCP Q1-2 PRD\] Single URL and OAuth Support](https://sailpoint.atlassian.net/wiki/spaces/~7120200fd8a6740fdb4ca9bd0f88f478f134a5/pages/4634738812/MCP+Q1-2+PRD+SailPoint+MCP+Server+Single+URL+and+Oauth+Support) · **PRD 2:** [\[MCP PRD\] Tenant-Agnostic Endpoint & OAuth Integration](https://sailpoint.atlassian.net/wiki/spaces/~7120200fd8a6740fdb4ca9bd0f88f478f134a5/pages/4342448180/MCP+PRD+Tenant-Agnostic+MCP+Server+Endpoint+Oauth+Integration)
...
**Rollout sequencing (May 2026):** Global URL ([APIMGMT-1699](https://sailpoint.atlassian.net/browse/APIMGMT-1699)) is in testing and does not block Gate 1. When AgentCore GW ships, registered clients may need migration off sp-token — see [`mcp-gateway-rollout-migration-sync.md`](mcp-gateway-rollout-migration-sync.md) and [DPDE-1773](https://sailpoint.atlassian.net/browse/DPDE-1773) (FR6).
...
| Rollout & migration sync (May 2026) | [`mcp-gateway-rollout-migration-sync.md`](mcp-gateway-rollout-migration-sync.md) |
| Server registry | [`../mcp-server-registry.md`](../mcp-server-registry.md) |
| Observability | [`../mcp-observability.md`](../mcp-observability.md) |
