...
**Related:** [MCP Platform hub](../README.md) · [`mcp-gateway-execution-plan.md`](mcp-gateway-execution-plan.md) · [`mcp-gateway-mvp-spec.md`](mcp-gateway-mvp-spec.md) · [`mcp-gateway.md`](mcp-gateway.md) · [`mcp-gateway-rollout-migration-sync.md`](mcp-gateway-rollout-migration-sync.md)
...
- [ ] **Client migration note** drafted for registered sp-token clients when AgentCore GW ships — see [`mcp-gateway-rollout-migration-sync.md`](mcp-gateway-rollout-migration-sync.md) ([DPDE-1773](https://sailpoint.atlassian.net/browse/DPDE-1773)).
